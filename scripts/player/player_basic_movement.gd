...
func _on_idle_state_entered() -> void:
	in_idle_state = true
	player_asset.play(idle_animation)
...
func _on_jump_state_entered() -> void:
	...
	player_asset.play(jump_animation)
