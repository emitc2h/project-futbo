...
# Skills
@export var seek_skill: SeekSkill3D
@export var dribble_skill: DribbleSkill3D
@export var kick_skill: KickSkill3D
@export var jump_skill: JumpSkill3D
...
func _on_attack_state_physics_processing(delta: float) -> void:
	...
	var distance_to_away_goal: float = CalcPhys3d.distance_x_positions(
	...
	# Aim for the goal and kick
		...
		var dir: float = CalcPhys3d.direction_x_positions(
			player.global_position, away_goal_position)
...
func _on_reset_state_physics_processing(delta: float) -> void:
	var distance_to_home_goal: float = CalcPhys3d.distance_x_positions(
